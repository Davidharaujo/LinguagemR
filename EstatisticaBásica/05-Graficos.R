# Parte 3 - Graficos em R: Barplot, Pie Chart, Scatter Plot, Histograma e Treemap
#http://www.r-graph-galerry.com
...
pie(fatias, labels=paises, main="Leitura de Livros por Pessoa")
...
title(main = "Produção de Veiculos", col.main="red", font.main=4)
